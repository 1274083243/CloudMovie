    ...
    public void setmDatas(List<String> mDatas){
        if (mDatas!=null&&mDatas.size()>0){
            ...
            for (int i=0;i<mDatas.size();i++){
                ...
                textView.setPadding(DpPxUtils.dip2px(5,getContext()),DpPxUtils.dip2px(5,getContext()),DpPxUtils.dip2px(5,getContext()),DpPxUtils.dip2px(5,getContext()));
                FrameLayout.LayoutParams params=new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                params.bottomMargin=DpPxUtils.dip2px(5,getContext());
                params.leftMargin=DpPxUtils.dip2px(5,getContext());
                params.topMargin=DpPxUtils.dip2px(5,getContext());
                params.rightMargin=DpPxUtils.dip2px(5,getContext());
